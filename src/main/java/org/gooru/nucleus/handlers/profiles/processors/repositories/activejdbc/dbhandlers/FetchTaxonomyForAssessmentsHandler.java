...
public class FetchTaxonomyForAssessmentsHandler implements DBHandler {
    ...
    public ExecutionResult<MessageResponse> executeRequest() {
        ...
        if (isPublic) {
            taxonomyList =
                Base.firstColumn(AJEntityCollection.SELECT_TAXONOMY_FOR_ASSESSMENTS_PUBLIC, context.userIdFromURL());
        } else {
            taxonomyList = Base.firstColumn(AJEntityCollection.SELECT_TAXONOMY_FOR_ASSESSMENTS, context.userIdFromURL(),
