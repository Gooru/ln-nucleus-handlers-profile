...
public class ListResourcesHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> checkSanity() {
    ...
    sortOn =
        sortOnFromRequest != null ? sortOnFromRequest : AJEntityOriginalResource.DEFAULT_SORTON;
  ...
  private void initializeQueryAndParams() {
    ...
    if (isPublic) {
      query.append(HelperConstants.SPACE).append(AJEntityOriginalResource.OP_AND)
