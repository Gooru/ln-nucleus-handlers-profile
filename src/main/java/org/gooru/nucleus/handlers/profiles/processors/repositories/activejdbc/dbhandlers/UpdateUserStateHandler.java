    ...
    if (this.context.request() == null || this.context.request().isEmpty()) {
      ...
      return new ExecutionResult<>(
          MessageResponseFactory
              .createInvalidRequestResponse("Invalid request body to update user client state"),
          ExecutionStatus.FAILED);
    }
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    ...
    if (userStates.isEmpty()) {
      ...
      if (this.clientState != null) {
        ...
        JsonObject result =
            (clientStateFromDB != null) ? clientStateFromDB.mergeIn(this.clientState)
                : this.clientState;
      ...
      if (this.systemState != null) {
        ...
        JsonObject result =
            (systemStateFromDB != null) ? systemStateFromDB.mergeIn(this.systemState)
                : this.systemState;
