...
public class AJEntityCourse extends Model {
  ...
  private static final String ORIGINAL_COURSE_ID = "original_course_id";
  ...
  private static final String AGGREGATED_TAXONOMY = "aggregated_taxonomy";
  ...
  public static final List<String> COURSE_LIST = Arrays
      .asList(ID, TITLE, DESCRIPTION, PUBLISH_STATUS, THUMBNAIL, OWNER_ID,
          ORIGINAL_CREATOR_ID, COLLABORATOR, ORIGINAL_COURSE_ID, TAXONOMY, SEQUENCE_ID,
          VISIBLE_ON_PROFILE, AGGREGATED_TAXONOMY, PRIMARY_LANGUAGE);

  public static final List<String> COURSE_FIELDS_FOR_COLLECTION = Arrays
      .asList(ID, TITLE, VISIBLE_ON_PROFILE);
