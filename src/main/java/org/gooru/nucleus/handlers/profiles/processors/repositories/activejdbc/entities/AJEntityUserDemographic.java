...
public class AJEntityUserDemographic extends Model {
    ...
    public static final String SELECT_DEMOGRAPHICS =
        "SELECT id, firstname, lastname, parent_user_id, user_category, birth_date, grade, course,"
    ...
    public static final List<String> ALL_FIELDS =
        Arrays.asList(ID, FIRSTNAME, LASTNAME, PARENT_USER_ID, USER_CATEGORY, BIRTH_DATE, GRADE, COURSE, TEMPLATE_PATH,
            GENDER, ABOUT_ME, SCHOOL_ID, SCHOOL, SCHOOL_DISTRICT_ID, SCHOOL_DISTRICT, EMAIL, COUNTRY_ID, COUNTRY,
            STATE_ID, STATE, METADATA, ROSTER_ID, ROSTER_GLOBAL_USERID, CREATED_AT, UPDATED_AT);
    public static final List<String> DEMOGRAPHIC_FIELDS =
        Arrays.asList(ID, FIRSTNAME, LASTNAME, TEMPLATE_PATH, SCHOOL_DISTRICT_ID, SCHOOL_DISTRICT, COUNTRY_ID, COUNTRY);
