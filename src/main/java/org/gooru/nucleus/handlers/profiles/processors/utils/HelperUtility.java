...
public final class HelperUtility {
  ...
  public static Integer getLimitFromRequest(ProcessorContext context) {
    ...
    try {
      ...
      int limitFromRequest =
          strLimit != null ? Integer.valueOf(strLimit) : appConfig.getDefaultPagesize();
      return limitFromRequest > appConfig.getMaxPagesize() ? appConfig.getDefaultPagesize()
          : limitFromRequest;
  ...
  public static Integer getOffsetFromRequest(ProcessorContext context) {
    try {
      ...
      return offsetFromRequest != null ? Integer.valueOf(offsetFromRequest)
          : HelperConstants.DEFAULT_OFFSET;
    } catch (NumberFormatException nfe) {
