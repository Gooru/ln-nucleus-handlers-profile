...
public class ListCollectionsHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if(isPublic) {
      LOGGER.debug("getting list of collections for public view");  
      collectionList = AJEntityCollection.findBySQL(AJEntityCollection.SELECT_COLLECTIONS_FOR_PUBLIC, context.userIdFromURL());
    } else {
      LOGGER.debug("getting list of collections for owner view"); 
      collectionList = AJEntityCollection.findBySQL(AJEntityCollection.SELECT_COLLECTIONS_FOR_OWNER, context.userIdFromURL());
    }
