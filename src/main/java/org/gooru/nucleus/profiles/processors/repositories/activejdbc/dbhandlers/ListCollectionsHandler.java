...
public class ListCollectionsHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    responseBody.put(HelperConstants.RESP_JSON_KEY_COLLECTIONS,
            new JsonArray(new JsonFormatterBuilder().buildSimpleJsonFormatter(false, AJEntityCollection.COLLECTION_LIST).toJson(collectionList)));
