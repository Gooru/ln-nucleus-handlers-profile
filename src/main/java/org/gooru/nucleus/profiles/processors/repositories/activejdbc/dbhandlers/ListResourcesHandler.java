...
public class ListResourcesHandler implements DBHandler {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if(isPublic) {
      LOGGER.debug("getting list of resources for public view");  
      resourceList = AJEntityContent.findBySQL(AJEntityContent.SELECT_RESOURCES_FOR_PUBLIC, context.userIdFromURL());
    } else {
      LOGGER.debug("getting list of resources for owner view"); 
      resourceList = AJEntityContent.findBySQL(AJEntityContent.SELECT_RESOURCES_FOR_OWNER, context.userIdFromURL());
    }
