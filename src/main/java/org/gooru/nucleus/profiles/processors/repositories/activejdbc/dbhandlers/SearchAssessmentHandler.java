...
public class SearchAssessmentHandler implements DBHandler {

  private final ProcessorContext context;
  private static final Logger LOGGER = LoggerFactory.getLogger(SearchAssessmentHandler.class);
  ...
  public SearchAssessmentHandler(ProcessorContext context) {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (isPublic) {
      selectQuery = AJEntityCollection.SEARCH_ASSESSMENTS_FOR_PUBLIC;
    } else {
      selectQuery = AJEntityCollection.SEARCH_ASSESSMENTS_FOR_OWNER;
    }
    ...
    LazyList<AJEntityCollection> assessmentList = AJEntityCollection.findBySQL(selectQuery, params.toArray());
