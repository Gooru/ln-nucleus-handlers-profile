...
public class SearchQuestionHandler implements DBHandler {

  private final ProcessorContext context;
  private static final Logger LOGGER = LoggerFactory.getLogger(SearchQuestionHandler.class);
  ...
  public SearchQuestionHandler(ProcessorContext context) {
  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (isPublic) {
      selectQuery = AJEntityContent.SEARCH_QUESTIONS_FOR_PUBLIC;
    } else {
      selectQuery = AJEntityContent.SEARCH_QUESTIONS_FOR_OWNER;
    }
    ...
    LazyList<AJEntityContent> questionList = AJEntityContent.findBySQL(selectQuery, params.toArray());
