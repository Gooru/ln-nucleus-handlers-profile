...
public class AJEntityCollection extends Model {
  ...
  public static final String SELECT_COURSE_TITLE_FOR_COLLECTION = "SELECT id, title FROM course WHERE id = ANY (?::uuid[]) AND is_deleted = false";
  ...
  public static final List<String> COLLECTION_LIST = Arrays.asList(ID, TITLE, COURSE_ID, PUBLISH_STATUS, THUMBNAIL, TAXONOMY, COLLABORATOR,
    VISIBLE_ON_PROFILE, LEARNING_OBJECTIVE, OWNER_ID, ORIGINAL_CREATOR_ID);
  public static final List<String> ASSESSMENT_LIST = Arrays.asList(ID, TITLE, COURSE_ID, PUBLISH_STATUS, THUMBNAIL, TAXONOMY, COLLABORATOR,
    VISIBLE_ON_PROFILE, LEARNING_OBJECTIVE, OWNER_ID, ORIGINAL_CREATOR_ID);
